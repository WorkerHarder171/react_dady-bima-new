...
function Main() {
  ...
  const handleOnChange = (e) => {
    ...
    if (type === "file") {
      ...
      // Validasi jika file ada sebelum memprosesnya
      if (file) {
        ...
        <form className="mx-auto my-5 w-50" onSubmit={handleSubmit}>
          ...
          <div className="form-body">
            ...
            <div className="product-name mt-3">
              <label className="text-start" htmlFor="productName">
                Product Name
              </label>
              <input
                type="text"
              ...
              {validation?.productName && (
                <div className="error py-2" data-testid="errorProductName"  style={{ color: "red" }}>
                  {validation?.productName}
                </div>
              )}
            </div>
            ...
            <div className="product-category mt-3">
              <label className="text-start" htmlFor="productCategory">Product Category</label>
              <select
            ...
            <div className="image-of-product mt-3">
              <label className="text-start" htmlFor="imageProduct">Image Of Product</label>
            ...
            <div className="product-freshness mt-3">
              <label className="text-start" htmlFor="productFreshness">Product Freshness</label>
            ...
            <div className="additional-desc mt-3">
              <label className="text-start" htmlFor="additionalDesc">Additional Description</label>
              <textarea
                name="additionalDesc"
                id="additionalDesc"
                cols={30}
            ...
            <div className="product-price mt-3">
              <label className="text-start" htmlFor="productPrice">Product Price</label>
              <div className="input-group mb-3">
